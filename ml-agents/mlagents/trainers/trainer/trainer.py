...
class Trainer(abc.ABC):
    ...
    def __init__(
        ...
        self.test_policy_queues: List[AgentManagerQueue[Policy]] = []
        self.trajectory_queues: List[AgentManagerQueue[Trajectory]] = []
        self.test_trajectory_queues: List[AgentManagerQueue[Trajectory]] = []
        self._step: int = 0
    ...
    def publish_test_policy_queue(self, policy_queue: AgentManagerQueue[Policy]) -> None:
        self.test_policy_queues.append(policy_queue)
    ...
    def subscribe_test_trajectory_queue(
        self, trajectory_queue: AgentManagerQueue[Trajectory]
    ) -> None:
        self.test_trajectory_queues.append(trajectory_queue)